...
export const neonButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-full border font-bold [font-family:var(--font-noto-sans-jp)] transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c038ff] focus-visible:ring-offset-2 focus-visible:ring-offset-black disabled:pointer-events-none disabled:opacity-45",
  {
    variants: {
      variant: {
        primary:
